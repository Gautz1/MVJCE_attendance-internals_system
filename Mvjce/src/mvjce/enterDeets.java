 ...
 */
public class enterDeets extends javax.swing.JFrame {

    /**
     * Creates new form enterDeets
     */
    static int dept;
    static int sem;
    static int internal;
    ...
    private void initComponents() {
        ...
        cb2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "I", "II", "III" }));
        ...
        cb3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2010", "2014", "CBCS" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        loginScreen ls=new loginScreen();
        sem=cb1.getSelectedIndex();
        internal=cb2.getSelectedIndex()+1;
        scheme=cb3.getSelectedIndex();
        dept=ls.dept;
        switch(dept){
            case 0:
                ia.l1.setText("AE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(enterDeets.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new enterDeets().setVisible(true);
            }
        });
    }
