...
public class Database {
    ...
    static void Select_scheme(String scheme,int screen) {
        ...
        ResultSet detail = st.executeQuery("select * from scheme where course='"+scheme+"'");
        detail.next();
        if(screen==1){
    ...
    String sub1,sub2,sub3,sub4,sub5,sub6,sub7,sub8,internal,name,section,sem,semester, sub1_name, sub1_code,sub1_class,sub1_ext;
    ...
    void Insert(String usn,int function){
        ...
        switch(function){
            ...
            case 2:
                ...
                break;
            case 3:
                st.execute("insert into Student_info values('"+usn+"','"+name+"','"+"','"+section+"','"+sem+"')");
                break;
...
//IMPORTANT ! DO NOT USE OR EDIT BELOW FUNCTION GAUTAM!!! :/
    ...
    void rep(String string, JComboBox<String> cb1, JTextField tf1) {
